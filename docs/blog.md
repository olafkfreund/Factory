...
The program journal for the Factory family — how PFactory, AIFactory, TFactory and
CFactory fit together, and what we learn building a governed, verified, observable
